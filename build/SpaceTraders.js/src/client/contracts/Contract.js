...
var Contract = /** @class */ (function () {
    function Contract(client, contract) {
        this.client = client;
        this.id = contract.id;
    ...
    Contract.prototype.accept = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1.default.post("https://api.spacetraders.io/v2/my/contracts/".concat(this.id, "/accept"), {}, { headers: { Authorization: "Bearer ".concat(this.client.token) } })];
                    case 1:
                        _a.sent();
                        this.accepted = true;
                        return [2 /*return*/];
